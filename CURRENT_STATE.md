...
| Packages/players | World package, initial pool, season bootstrap, Run prospect services and `initial_world_states` | Initial lifecycle and ordinary-week birthday/age-46 retirement truth are owned and historically saved; development/recovery remain open and prospects fail closed without an authoritative owned source |
