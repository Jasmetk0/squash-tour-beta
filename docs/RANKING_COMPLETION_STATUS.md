...
| Season Closing Ranking | `season_closing_ranking.v1` calculates the archived Week-61 snapshot under the outgoing policy; ordinary-season resolver/staging now derives it from the published Week 61 head, lifecycle, frozen owned tournament sources and historical result/discipline state without publishing or advancing world time | Saved Revision integration, closure marker/season summary, full atomic Season Transition and the dedicated final-season source adapter; final season must not create Week 1 of season 51 |
