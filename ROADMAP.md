...
| 2 — one true week boundary (implemented expanded slice) | One SQLite owner develops canonical 57-attribute sporting state, performs provisional Form/Sharpness/Fatigue between-week updates, derives lifecycle roster, then atomically publishes/advances/audits | Completed-match sporting context and health remain explicit boundaries; matching Run prospects fail closed; next prove repeated flow and public consumers |
