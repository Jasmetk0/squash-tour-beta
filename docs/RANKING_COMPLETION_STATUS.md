...
Status after independent ranking Save (follow-up to #711). Rankings are **not
...
| Inspection | Admin candidate, source and input APIs/UI | Public historically faithful Viewer ranking path |
