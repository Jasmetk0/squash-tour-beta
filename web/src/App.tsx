...
import { WorldLibraryDetailPage, WorldLibraryPage, WorldPackageCountriesPage, WorldPackageCountryCreatePage, WorldPackageCountryDetailPage } from './pages/WorldLibraryPage'
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="admin/world/library/:worldId/countries/new" element={<WorldPackageCountryCreatePage />} />
