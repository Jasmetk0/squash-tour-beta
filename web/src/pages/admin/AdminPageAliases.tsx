      ...
      <LinkCardGrid
        cards={[
          ...
          },
          {
            ...
            description: 'Read-only fixed registry for seasons 2000/01 through 2049/50, 61 weeks per season, SW1 = YW37.',
            to: '/admin/tour-seasons/season-registry'
          },
          {
            title: 'Seasons',
            description: 'Concrete 61-week season calendars from 2000/01 through 2049/50.',
            to: '/admin/seasons'
          },
          {
