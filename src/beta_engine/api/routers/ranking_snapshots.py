...
def get_admin_ranking_snapshot(
    ...
    return _raise_on_errors(service.get_snapshot(season=normalize_season_for_legacy_services(season), season_week=season_week))
...
def generate_admin_ranking_snapshot(
    ...
    return _raise_on_errors(service.generate_snapshot(season=normalize_season_for_legacy_services(season), season_week=season_week, request=request))
