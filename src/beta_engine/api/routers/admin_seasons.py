...
def _build_template_conflict_diagnostics_overview(
    *,
...
def preflight_season_builder(
    ...
    preflight_template_conflict_diagnostics_overview = _build_template_conflict_diagnostics_overview(
...
def post_season_builder_dry_run_build_contract(
    ...
    dry_run_template_conflict_diagnostics_overview = _build_template_conflict_diagnostics_overview(
