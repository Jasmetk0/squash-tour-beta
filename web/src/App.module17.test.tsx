...
describe('Module 17 pages through routes', () => {
  ...
  it('renders Tour & Seasons hub and shell routes while keeping operational routes available', async () => {
    ...
    expect(screen.getByText(/Locked events must be explicitly unlocked before move\/delete\/overwrite actions\./)).toBeInTheDocument()
    ...
    const registryTableSection = screen.getByRole('heading', { name: 'Registry table' }).closest('section')
