...
| Season Closing Ranking | `season_closing_ranking.v1` calculates the archived Week-61 snapshot under the outgoing policy; seasons 0–48 now persist completed Week-61 tournament sources before the season boundary, ordinary-season resolver/staging derives the archive from canonical Week-61 state, and `ranking_revision_state.v6` preserves/restores it against its exact publication | Closure marker/season summary, full atomic Season Transition and the dedicated final-season source adapter; final season must not create Week 1 of season 51 |
