...
| Recovery | Versioned bundles include owned tournament evidence, independent explicit Save, reload and guarded saved-component restore | Complete sporting-world snapshot/recovery and ranking-bearing forks |
| Season Closing Ranking | `season_closing_ranking.v1` now calculates a separate archived Week-61 closing snapshot under the outgoing policy and persists it append-only against the exact Week 61 Official head; it does not publish or advance world time | Canonical production source resolver, Saved Revision integration, Season Transition staging, closure marker/season summary and the final-season source edge; final season must not create Week 1 of season 51 |
